        ...
        <div className="flex items-center space-x-2">
          {activeFilterCount > 0 && (
            <button
              ...
              className="text-sm text-gray-900 hover:text-gray-900 font-medium whitespace-nowrap"
            >
              Clear All
            </button>
          )}
              ...
              {categories.map((category) => (
                <label key={category} className="flex items-center space-x-3 cursor-pointer group">
                  <input
                    ...
                    className="w-5 h-5 text-gray-900 border-gray-300 rounded focus:ring-gray-600"
                  />
