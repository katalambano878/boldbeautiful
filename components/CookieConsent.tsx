            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-start space-x-4 flex-1">
                <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-lg flex-shrink-0">
                  <i className="ri-cookie-line text-2xl text-gray-900"></i>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-3">
                    ...
                    <Link href="/privacy" className="text-gray-900 hover:text-gray-900 font-medium ml-1 whitespace-nowrap">
                  ...
                  <label className="flex items-start space-x-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 mt-0.5 text-gray-900 border-gray-300 rounded focus:ring-gray-600 cursor-pointer"
                    />
                    <span className="text-xs text-gray-600 group-hover:text-gray-900">
                      I agree to the{' '}
                      <Link href="/terms" className="text-gray-900 hover:text-gray-900 font-medium">
                        Terms & Conditions
                      </Link>
                      {' '}and{' '}
                      <Link href="/privacy" className="text-gray-900 hover:text-gray-900 font-medium">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
