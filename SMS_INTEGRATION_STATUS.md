...
| `MOOLRE_API_USER` | User ID from Moolre | Yes |
...
| Variable | Purpose | Required |
|----------|---------|----------|
| `NEXT_PUBLIC_APP_URL` | Production URL (e.g., `https://www.yourdomain.com/`) | Yes |
...
```
https://<YOUR_DOMAIN>/api/payment/moolre/callback
```
