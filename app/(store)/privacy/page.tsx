        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us at <a href="mailto:pobeenina2@gmail.com" className="text-gray-900 font-medium hover:underline">pobeenina2@gmail.com</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:pobeenina2@gmail.com" className="text-gray-900 hover:underline">pobeenina2@gmail.com</a>
                  </div>
                </div>
