...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'pobeenina2@gmail.com';
const STORE_NAME = process.env.NEXT_PUBLIC_SITE_NAME || 'Bold & Beautiful';
const EMAIL_FROM = process.env.EMAIL_FROM || `${STORE_NAME} <noreply@boldnbeautiful.store>`;
...
const BRAND = {
    ...
    colorLight: '#f3f4f6',
    colorDark: '#171717',
    url: (process.env.NEXT_PUBLIC_APP_URL || 'https://www.boldnbeautiful.store').replace(/\/+$/, ''),
